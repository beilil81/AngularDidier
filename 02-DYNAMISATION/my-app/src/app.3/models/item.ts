...
export class Item{
    ...
    public toggleAnimateState(){
        this.animateState = this.animateState === 'inactive' ? 'active' : 'inactive'; // teste: en fonction de l'état passe à l'etat inverse
        //console.log(this.animateState); // quand on clique sur pannel, dans console on voit active/inactive/active etc.
    }
}