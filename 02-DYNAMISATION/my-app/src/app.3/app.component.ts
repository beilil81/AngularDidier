...
export class AppComponent { // (export pour rendre la classe "exportable")
 // 1.1.1 déclarer deux variables avec visibilité et typage dans notre classe
  ...
  //  3.1.1 ajouter un setTimeOut dans la méthode createObject() pour passer l'état  à remove après 2 secondes
    setTimeout( ()=> { // 3.1.2 remplacer push par un unShift pour add item au debut de declaration
